        ...
        <div class='vicp-wrap'>
            ...
            <div class='modify-cont' v-if='form'>
                ...
                <el-form-item label='生日'>
                    ...
                    <el-col class='line' :span='2'>日</el-col>
                </el-form-item>
                ...
                <el-form-item label='复选框'>
                    ...
                    <el-checkbox label='单光' name='type'></el-checkbox>
                    </el-checkbox-group>
                </el-form-item>
                ...
                <el-form-item label='下拉列表'>
                    <el-select v-model='form.region' placeholder='多选'>
                    <el-option label='区域一' value='shanghai'></el-option>
                    <el-option label='区域二' value='beijing'></el-option>
                    </el-select>
                </el-form-item> -->
                ...
                <el-col :span='10'>
                    ...
                    <el-select
                        v-model='form.addrForm.consigneeProvince'
                        placeholder='省份'
                    >
                        <el-option
                        v-for='item in form.frontData.province'
                        :key='item.id'
                        :label='item.value'
                        :value='item.id'
                        >
                ...
                <el-col :span='10'>
                    ...
                    <el-select v-model='form.addrForm.consigneeCity' placeholder='城市'>
                        <el-option
                        v-for='item in form.frontData.city'
                        :key='item.id'
                        :label='item.value'
                        :value='item.id'
                        >
                ...
                <el-form-item label='详细地址'>
                    <el-input type='textarea' v-model='form.desc' placeholder='详细地址'></el-input>
                </el-form-item>
